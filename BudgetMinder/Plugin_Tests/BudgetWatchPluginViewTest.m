...
- (void) setUp
{
	...
	BudgetWatchPluginView* view = [BudgetWatchPluginView plugInViewWithArguments:dict];
}
...
*/
	STAssertNotNil(dict, @"The BudgetWatchPluginView was not correctly allocated");
}
