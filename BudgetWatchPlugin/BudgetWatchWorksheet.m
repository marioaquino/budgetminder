...
@interface BudgetWatchWorksheet (private)

- (BudgetWatchWorksheet*) initWithUser: (NSString*) user andPassword: (NSString*) password  usingDelegate: (id) theDelegate;
...
@implementation BudgetWatchWorksheet

+ (BudgetWatchWorksheet*) newWithUser: (NSString*) user andPassword: (NSString*) password  usingDelegate: (id) theDelegate
{
	return [[BudgetWatchWorksheet alloc] initWithUser: user andPassword: password usingDelegate: theDelegate];
}
...
- (BudgetWatchWorksheet*) initWithUser: (NSString*) user andPassword: (NSString*) password  usingDelegate: (id) theDelegate
{
	...
	[service setUserAgent: @"user agent thingy"];
